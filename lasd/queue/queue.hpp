...
public:
  ...
  // Copy assignment
  virtual Queue &operator=(const Queue<Data>&) = delete; // Copy assignment of abstract types should not be possible.

  // Move assignment
  virtual Queue &operator=(Queue<Data>&&) noexcept = delete; // Move assignment of abstract types should not be possible.

  /* ************************************************************************ */

  // Comparison operators
  virtual bool operator==(const Queue<Data>&) const = delete; // Comparison of abstract types might not be possible.
  virtual bool operator!=(const Queue<Data>&) const = delete; // Comparison of abstract types might not be possible.
